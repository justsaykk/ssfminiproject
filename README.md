...
| ------------------------ | :------------------------------------------------------------------ | :----------------------- | :-------------------------------------------------------------------- |
| UUID                     | N/A                                                                 | Retrieve from email key  | 1. Retrieve email from profilemap <br> 2.Retrieve uuid from email key |
| EMAIL                    | Retrieve from uuidmap                                               | N/A                      | Retrieve from profilemap                                              |
| NAME                     | 1. Retrieve email from uuidmap <br> 2. Retrieve name from email key | Retrieve from profilemap | N/A                                                                   |
